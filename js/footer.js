...
<div class="m-nav-panel" id="mNavPanel">
    ...
    <a href="index.html#contact" class="m-nav-cta">
        ...
        <div class="m-nav-socials" aria-label="Social media">
            <a href="https://www.instagram.com/adzio.io/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <span class="social-tip" aria-hidden="true"><span class="social-tip-sizer">Follow on Instagram</span><span class="social-tip-text"></span></span>
            </a>
            ...
            <a href="https://x.com/AdzioMarketing" target="_blank" rel="noopener noreferrer" aria-label="X">
                ...
                <span class="social-tip" aria-hidden="true"><span class="social-tip-sizer">Follow on X</span><span class="social-tip-text"></span></span>
            </a>
        </div>
        <div class="m-nav-contact" aria-label="Contact information">
            <a class="m-nav-contact-icon m-nav-contact-icon--email" href="mailto:Marketing@Adzio.io" aria-label="Email Adzio">
                ...
                <span class="social-tip" aria-hidden="true"><span class="social-tip-sizer">Email Adzio</span><span class="social-tip-text"></span></span>
            </a>
    ...
    function initSocialTips() {
        var links = document.querySelectorAll('.social-link, .contact-item, .abt-feed-item, .m-nav-socials a, .m-nav-contact-icon');
